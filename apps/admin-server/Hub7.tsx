...
Command: npx gltfjsx@6.2.13 C:\Users\fgarr\Documents\lab\youtube3d\apps\admin\public\assets\hub7.glb --types 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    ['emissive red']: THREE.MeshStandardMaterial
  }
}

type ActionName = 'DoorAction' | 'Point.004Action' | 'Cylinder.001Action'
...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/hub7.glb') as GLTFResult
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <spotLight name="Point004_1" intensity={61563.843} angle={0.487} penumbra={1} decay={2} distance={40} position={[0.615, 15.617, 55.679]} rotation={[-1.575, 0.016, 0.423]}>
          <group position={[0, 0, -1]} />
        </spotLight>
        <spotLight name="Point005" intensity={61563.843} angle={0.487} penumbra={1} decay={2} distance={40} position={[0.615, 15.617, 47.49]} rotation={[-0.418, -0.013, 1.356]}>
          <group position={[0, 0, -1]} />
        </spotLight>
        ...
        <group name="Door" position={[0.407, 4.033, 32.025]} rotation={[Math.PI / 2, 0, 0]} scale={[0.006, 0.003, 0.009]}>
        ...
        <mesh name="Cube036" geometry={nodes.Cube036.geometry} material={materials.Marble} position={[0.002, 1.397, 57.146]} />
        <mesh name="Cylinder001" geometry={nodes.Cylinder001.geometry} material={materials['emissive red']} position={[-0.383, 2.757, 56.281]} scale={[0.1, 0.113, 0.1]} />
      </group>
    </group>
  )
}

useGLTF.preload('/hub7.glb')
