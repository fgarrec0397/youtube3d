...
Command: npx gltfjsx@6.2.13 C:\Users\fgarr\Documents\lab\youtube3d\apps\admin\public\assets\hub8.glb --types 
*/
...
type ActionName = 'DoorAction' | 'Cylinder.001Action'
...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/hub8.glb') as GLTFResult
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <spotLight name="Point004_1" intensity={61563.843} angle={0.487} penumbra={1} decay={2} distance={40} position={[0.615, 15.617, 65.369]} rotation={[-1.575, 0.016, 0.423]}>
          <group position={[0, 0, -1]} />
        </spotLight>
